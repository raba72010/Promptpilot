...
export function DecisionSummary({ intent, recommendation, aiEnhanced }: DecisionSummaryProps) {
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div
          ...
          title={aiEnhanced ? "Prompt generated by Claude AI" : "Generated by built-in engine"}
        >
          <Sparkles className="h-3.5 w-3.5" />
          {aiEnhanced ? "AI Enhanced" : "Classic"}
        </div>
      </div>
